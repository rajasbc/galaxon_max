...
$obj = new Customers();
$customer = $obj->get_customer_detail();
  ...
  <div class="content-wrapper watermark_img">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Customer Collection Reports</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Customer Collection</li>
...
type: "GET",
dataType:"html",
url: '../ajaxCalls/customer_sale_variety.php',
...
$.ajax({
  ...
  type:'post',
  url:'../ajaxCalls/customer_sale_reports.php',
  dataType:'JSON',
