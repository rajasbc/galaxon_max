...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-12">
          ...
          <div class="container mt-4">
            ...
            <input type="hidden" name='id' value='<?=$result1[0]['id']?>'>
            <div class="form-row">
 ...
 -->
            ...
            <div class="form-row">
              <div class="form-group col-lg-4 mt-2"><span>Comments / Special Instruction&nbsp;<label class="text-danger"></label></span></div><div class="form-group col-lg-8"><textarea name='declaration' id='declaration' class="form-control " ><?=$result1[0]['declaration']?></textarea></div>
            </div>
