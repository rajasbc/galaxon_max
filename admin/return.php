...
<div class="content-wrapper ">
  ...
  <section class="content ">
    <div class="container-fluid ">
            ...
            <div class="card-body row col-12">
              <div class="row col-12">
               ...
               <div class="col-3 form-group mb-2">
                 ...
                 <input type="hidden" name="sno" id="sno" value="0">
                 <input type="hidden" name="tbranch_id" id="tbranch_id" >
                 <input type="text" name="tbranch" id="tbranch" class="form-control" placeholder="Enter Branch Name" autofocus>
               </div>
                ...
                <!-- <div class="row col-12" id="branch_dt" style="display: none;">
                  
                <div class="col-11">
                  <label>Branch Details</label><br>
                  <div class="row col-12">
                    <div class="col-6">
                      <label>Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label><span id="branch_name"></span>
                    </div>
                   
                    <div class="col-6">
                      <label>Mobile No :</label><span id="branch_mobile"></span>
                    </div>
                    <div class="col-6" id="b_email">
                      <label>Email &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label><span id="branch_email"></span>
                    </div>
                    <div class="col-6" id="b_gst">
                      <label>GST No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label><span id="branch_gst"></span>
                    </div>
                  </div>
                </div>
                <div class="col-1">
                  <img src="" id="branch_image" style="width: 100px;height: 100px;border-radius: 50px;">
                </div>
              </div> -->
     ...
     <div class="col-1 form-group mb-3 text-center" style="vertical-align: center">
       <button class="btn btn-primary" id="add_item" style="margin-top: 40px;">Add</button>
     </div>
   </form>
   <br>
   ...
   <tfoot >
    <tr >
      <td colspan="13" class="td-last-1 hide">
       <div class="row">
  ...
  <div class="row col-12">
    ...
    <div class="col-8 text-right">
      ...
      <div class="row col-12 mt-2 text-right">
        ...
        <div class="col-6 text-center">
          <button class="col-12 btn btn-primary" id="place_order">Return</button>
        </div>
...
<script type="text/javascript">
  ...
  function get_vendor_dt(e){
    $.ajax({
      type: "POST",
      dataType:"json",
      url: '../ajaxCalls/get_branch_return.php',
      data: {'branch_id':e},
      success: function(res){
        $("#branch_name").html(res.name+' - '+res.branch_code);
    // $("#vendor_company_name").html(res.company_name);
    $("#branch_mobile").html(res.mobile_no);
    if (res.email!='') {
      $("#branch_email").html(res.email);
      $("#b_email").css('display','');
    }else{
      $("#b_email").css('display','none');
    }
    if (res.shop_gst_no!='' && res.shop_gst_no!=null) {
      $("#branch_gst").html(res.shop_gst_no);
      $("#b_gst").css('display','');
    }else{
      $("#b_gst").css('display','none');
    }
    
    if (res.shop_image!='') {
      $("#branch_image").attr('src','../uploads/'+res.shop_image);
      $("#branch_image").css('display','');
    }else{
      $("#branch_image").css('display','none');
    }
    
    $("#branch_dt").css('display','');
...
<script type="text/javascript">
  ...
  $('#branch').autocomplete({
    source: "../ajaxCalls/autocomplete_branch_list.php",
    minLength: 1,
    select: function(event,ui)
    {
...
$("#place_order").click(function(){
  ...
  detailsarray = [];
  detailsarray['branch_id']=branch_id;
  detailsarray['tbranch_id']=tbranch_id;
  ...
  $.ajax({
    type: "POST",
    dataType:"json",
    url: '../ajaxCalls/add_return.php',
    data: $.param(obj)+'&'+$.param(dobj),
    success: function(res){
      if (res.status=='success') {
        global_alert_modal('success',' Return SuccessFully...');
        window.location ='return_item.php';
